...
enum RBACPermissions
{
    ...
    RBAC_PERM_COMMAND_UTILITY_CHANGE_RACE					 = 1000, //Custom utility changerace
    RBAC_PERM_COMMAND_UTILITY_CHANGE_FACTION				 = 1001, //Custom utility changefaction
    RBAC_PERM_COMMAND_UTILITY_MAXSKILLS					     = 1002, //Custom utility maxskills
    RBAC_PERM_COMMAND_UTILITY_CUSTOMIZE				         = 1003, //Custom utility customize
