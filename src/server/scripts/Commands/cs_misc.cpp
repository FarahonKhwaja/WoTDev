...
public:
    ...
    ChatCommand* GetCommands() const override
    {
        static ChatCommand commandTable[] =
        {
            ...
            { "utility change race",  rbac::RBAC_PERM_COMMAND_UTILITY_CHANGE_RACE, false, &HandleChangeRaceCommand,  "", NULL },
            { "utility change faction",  rbac::RBAC_PERM_COMMAND_UTILITY_CHANGE_FACTION, false, &HandleChangeFactionCommand,  "", NULL },
            { "utility maxskills",  rbac::RBAC_PERM_COMMAND_UTILITY_MAXSKILLS, false, &HandleMaxSkillsCommand,  "", NULL },
            { "utility customize",  rbac::RBAC_PERM_COMMAND_UTILITY_CUSTOMIZE, false, &HandleCustomizeCommand,  "", NULL },
